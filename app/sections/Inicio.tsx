  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full py-12 px-6 text-center">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-brand-light rounded-full blur-[120px] opacity-30" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-light rounded-full blur-[120px] opacity-25" />
      </div>
      ...
      >
        ...
        <motion.div variants={item} transition={{ duration: 0.5 }} className="relative inline-block mb-8">
          <img
            ...
            className="w-28 h-28 md:w-36 md:h-36 rounded-full mx-auto object-cover border-4 border-white shadow-2xl relative z-10"
          />
          <motion.div
        ...
        <motion.div variants={item} transition={{ duration: 0.5 }} className="flex justify-center mb-6">
          <span className="inline-flex items-center gap-2 bg-white border border-gray-100 shadow-sm px-4 py-1.5 rounded-full text-xs font-bold text-gray-500">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-extrabold mb-4 tracking-tight text-carbon leading-[1.1]"
        >
          Hola, soy{" "}
        ...
        <motion.p
          variants={item}
          transition={{ duration: 0.5 }}
          className="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed max-w-xl mx-auto"
        >
        ...
        >
          <motion.button
            ...
            className="group w-full sm:w-auto bg-carbon text-white px-10 py-4 rounded-2xl font-bold text-base shadow-xl shadow-gray-200 flex items-center justify-center"
          ...
          <motion.button
            ...
            className="w-full sm:w-auto bg-white text-carbon border-2 border-gray-100 px-10 py-4 rounded-2xl font-bold text-base flex items-center justify-center"
